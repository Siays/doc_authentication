...
export const LayoutContext = createContext<{ setTitle: (title: string) => void }>({ setTitle: () => {} });
          ...
          <DisclosurePanel className="md:hidden">
            ...
            <div className="border-t border-gray-700 pt-4 pb-3">
              <div className="flex items-center px-5">
                ...
                <div className="ml-3">
                  <div className="text-base/5 font-medium text-white">User name{/*user.name*/}</div>
                  <div className="text-sm font-medium text-gray-400">Email {/*user.email*/}</div>
                </div>
                <button
                  type="button"
